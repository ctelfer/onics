...
#define PRP_ICMP6_NXFIELDS	13
#define PRP_ICMP6FLD_ECHO	(PRP_OI_EXTRA + 0)	/* ID, SEQ */
#define PRP_ICMP6FLD_ND		(PRP_OI_EXTRA + 1)	/* flags, ip6a */
#define PRP_ICMP6FLD_NDOPT	(PRP_OI_EXTRA + 2)
#define PRP_ICMP6FLD_SRCLLA	(PRP_OI_EXTRA + 3)
#define PRP_ICMP6FLD_SRCLLA_EOFF	(PRP_OI_EXTRA + 4)
#define PRP_ICMP6FLD_TGTLLA	(PRP_OI_EXTRA + 5)
#define PRP_ICMP6FLD_TGTLLA_EOFF	(PRP_OI_EXTRA + 6)
#define PRP_ICMP6FLD_PFXINFO	(PRP_OI_EXTRA + 7)
#define PRP_ICMP6FLD_RDRHDR	(PRP_OI_EXTRA + 8)
#define PRP_ICMP6FLD_RDRHDR_EOFF	(PRP_OI_EXTRA + 9)
#define PRP_ICMP6FLD_MTU	(PRP_OI_EXTRA + 10)
#define PRP_ICMP6FLD_RADVIVL	(PRP_OI_EXTRA + 11)
#define PRP_ICMP6FLD_AGTINFO	(PRP_OI_EXTRA + 12)
