...
enum {
  ...
  NETVM_CPOC_PRIPV6,    /* [vhi,vlo] print IPv6 address (network byte order) */
...
enum {
  NETVM_CPOC_REXP,      /* [pa,len,rxidx,(pktnum,nmatch)|I]:regex on packet data */
  NETVM_CPOC_REXM,      /* [addr,len,rxidx, nmatch|I]: regex on memory data */
